...
PATCH=$(kubectl get cm across6nodes -n $NS -o yaml | yq '.data.rgnb |= (. | fromjson | .topology.links += [{"endpoints": ["macvlan:net2004", "rgnb:eth1"]}] | tojson)'); kubectl patch cm across6nodes -n $NS -o yaml --patch "$PATCH"
PATCH=$(kubectl get cm across6nodes -n $NS -o yaml | yq '.data.rgnb |= (. | fromjson | .topology.links += [{"endpoints": ["macvlan:net2002", "rgnb:eth2"]}] | tojson)'); kubectl patch cm across6nodes -n $NS -o yaml --patch "$PATCH"
PATCH=$(kubectl get cm across6nodes -n $NS -o yaml | yq '.data.rg |= (. | fromjson | .topology.links += [{"endpoints": ["macvlan:net2004", "rg:eth1"]}] | tojson)'); kubectl patch cm across6nodes -n $NS -o yaml --patch "$PATCH"
PATCH=$(kubectl get cm across6nodes -n $NS -o yaml | yq '.data.rg |= (. | fromjson | .topology.links += [{"endpoints": ["macvlan:net1001", "rg:eth2"]}] | tojson)'); kubectl patch cm across6nodes -n $NS -o yaml --patch "$PATCH"
PATCH=$(kubectl get cm across6nodes -n $NS -o yaml | yq '.data.rg |= (. | fromjson | .topology.links += [{"endpoints": ["macvlan:net1004", "rg:eth3"]}] | tojson)'); kubectl patch cm across6nodes -n $NS -o yaml --patch "$PATCH"
...
PATCH=$(kubectl get cm across6nodes -n $NS -o yaml | yq '.data.hgnb-h1 |= (. | fromjson | .topology.links += [{"endpoints": ["macvlan:net2002", "hgnb-h1:eth1"]}] | tojson)'); kubectl patch cm across6nodes -n $NS -o yaml --patch "$PATCH"
PATCH=$(kubectl get cm across6nodes -n $NS -o yaml | yq '.data.hgnb-h2 |= (. | fromjson | .topology.links += [{"endpoints": ["macvlan:net2002", "hgnb-h2:eth1"]}] | tojson)'); kubectl patch cm across6nodes -n $NS -o yaml --patch "$PATCH"
PATCH=$(kubectl get cm across6nodes -n $NS -o yaml | yq '.data.hgnb-h3 |= (. | fromjson | .topology.links += [{"endpoints": ["macvlan:net2002", "hgnb-h3:eth1"]}] | tojson)'); kubectl patch cm across6nodes -n $NS -o yaml --patch "$PATCH"
